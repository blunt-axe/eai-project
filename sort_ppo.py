...
class NatureCNN(nn.Module):
    def __init__(self, sample_obs, feature_size=256, epsilon=1e-8, clip_obs=5.0):
        ...
        if "rgb" in sample_obs:
            ...
            self.out_features += feature_size * 3
    ...
    def forward(self, observations) -> torch.Tensor:
        ...
        if "rgb" in observations:
            ...
            rgb_features = torch.cat([feat_v1, feat_v2, feat_v3], dim=1)
...
if __name__ == "__main__":
    ...
    if args.capture_video:
        ...
        if args.save_train_video_freq is not None:
            ...
            envs = RecordEpisode(envs, output_dir=f"runs/{run_name}/train_videos", save_trajectory=False, save_video_trigger=save_video_trigger, max_steps_per_video=400, video_fps=30)
        eval_envs = RecordEpisode(eval_envs, output_dir=eval_output_dir, save_trajectory=args.evaluate, trajectory_name="trajectory", max_steps_per_video=400, video_fps=30)
